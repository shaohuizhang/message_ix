...
map_tec_extended(node,tec,year_all)$(technical_lifetime(node,tec,year_all) AND %cap_comm% = 1) = yes  ;
*----------------------------------------------------------------------------------------------------------------------*
...
*                                                       AND first_period(year_all) AND seq_period(year_all2,year_all) AND %cap_comm% = 1) = yes ;
...
*                                                                        AND NOT map_tec_lifetime_extended(location,tec,vintage,year_all) AND %cap_comm% = 1) = yes;
...
*                                                                          AND (remaining_capacity_extended(location,tec,vintage,year_all)>0) AND %cap_comm% = 1) = yes;
...
map_tec_lifetime_extended(node,tec,year_all,year_all)$( map_tec_extended(node,tec,year_all) AND %cap_comm% = 1) = yes ;
